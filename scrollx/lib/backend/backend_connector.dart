...
class BackendConnector {
  ...
  Future<List> getAllMovies() async {
    final response = await http.get(Uri.parse('https://192.168.0.62:5000/get-all-movies'));
  ...
  Future<List> getSeriesOfMovie(int movieId) async {
    final response = await http.post(
      Uri.parse('https://192.168.0.62:5000/get-series-of-movie'),
  ...
  Future<List> getEpisodesOfSerie(int serieId) async {
    final response = await http.post(
      Uri.parse('https://192.168.0.62:5000/get-episodes-of-serie'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, int>{
  ...
  Future<List> getScrollsOfEpisode(int episodeId) async {
    final response = await http.post(
      Uri.parse('https://192.168.0.62:5000/get-scrolls-of-episode'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, int>{
